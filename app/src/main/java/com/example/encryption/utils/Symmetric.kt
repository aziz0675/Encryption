...
object Symmetric {
    ...
    fun setKey(myKey: String) {
        /**
         * Message digest -> ixtiyoriy o'lchamdagi ma'lumotlarni oladigan va belgilangan
         * uzunlikdagi xesh qiymatini chiqaradigan xavfsiz bir tomonlama xesh funksiyalaridir.
         */
